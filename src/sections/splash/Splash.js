import { AspectRatio, Box, ButtonGroup, IconButton, Stack, Typography } from "@mui/joy";
...
export default function(){
    return (
        <Box display="flex" height="95vh" width="vw" alignItems="center" justifyContent="center">
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={4} alignItems="center">
                <AspectRatio variant="scaleDown" objectFit="cover" ratio="3/4" sx={{ width: 250, backgroundColor: "lightgray", borderRadius: "1em", boxShadow: 1}}>
                    <img src="assets/images/Profile.JPG" alt="James Taintor Profile Photo" style={{"objectPosition" : "top 0 left -105px"}}/>
                </AspectRatio>
